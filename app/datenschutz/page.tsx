...
export default function Datenschutz() {
  return <><SiteHeader /><main className="legal-page shell">
    ...
    <h2>6. Widerruf und Änderung</h2><p>Eine erteilte Einwilligung kann jederzeit mit Wirkung für die Zukunft geändert werden. Über „Datenschutz-Einstellungen“ im Fußbereich jeder Seite wird die Auswahl erneut geöffnet. Alternativ kann der Eintrag „st-consent“ im lokalen Speicher des Browsers gelöscht werden.</p>
