...
function RentalYieldTool() {
  ...
  const [ancillaryRate, setAncillaryRate] = useState("10");
  const [annualOwnerCosts, setAnnualOwnerCosts] = useState("1800");
...
function PurchaseCostsTool() {
  ...
  const [notaryRate, setNotaryRate] = useState("2");
  const [brokerRate, setBrokerRate] = useState("3.57");
  const purchase = number(purchasePrice);
...
function CashflowTool() {
  ...
  const [loanRate, setLoanRate] = useState("760");
  const [ownerCosts, setOwnerCosts] = useState("120");
